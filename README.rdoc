...
Every document is parsed using a language. +english+ is the default language for every record. You can change it with +config.make_text_search.default_language+. For example, add
